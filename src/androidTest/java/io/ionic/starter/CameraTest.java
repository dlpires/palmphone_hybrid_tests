...
public class CameraTest {
    ...
    public void cameraTest() {
        ...
        onWebView().withElement(findElement(Locator.XPATH, "//option[contains(@value, 'disc')]"))
                .perform(webClick())
        ...
        //ABRINDO LEITOR DE CÓDIGO DE BARRA
        ...
        //fechando janela que a leitura não foi realizada
        onWebView().withElement(findElement(Locator.XPATH, "//button[contains(@class, 'alert-button')]"))
                .perform(webClick());
